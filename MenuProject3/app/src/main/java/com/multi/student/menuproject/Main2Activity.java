...
import static com.multi.student.menuproject.ListAdapter.checkit;
import static com.multi.student.menuproject.ListAdapter.checklike;
import static com.multi.student.menuproject.ListAdapter.checklist;
import static com.multi.student.menuproject.ListAdapter.inte;
...
//                table에서 각 어트리뷰트에 넣음
                ...
                Product p1 = new Product(checkit,checklike,R.mipmap.menu_refresh,name,count,enddate,cal);
                plist.add(p1);
            }
            adapter.notifyDataSetChanged();
